...
$namesss=$_POST['namesss'];
$tracknosss=$_POST['tracksss'];
$namessss=$_POST['namessss'];
$tracknossss=$_POST['trackssss'];
$namesssss=$_POST['namesssss'];
$tracknosssss=$_POST['tracksssss'];
$namessssss=$_POST['namessssss'];
$tracknossssss=$_POST['trackssssss'];
$namesssssss=$_POST['namesssssss'];
$tracknosssssss=$_POST['tracksssssss'];
$namessssssss=$_POST['namessssssss'];
$tracknossssssss=$_POST['trackssssssss'];
$namesssssssss=$_POST['namesssssssss'];
$tracknosssssssss=$_POST['tracksssssssss'];
...
mysqli_query($con,$sql);
$sql="INSERT INTO details (name,trackno) VALUES ('$namesss','$tracknosss');";
mysqli_query($con,$sql);
$sql="INSERT INTO details (name,trackno) VALUES ('$namessss','$tracknossss');";
mysqli_query($con,$sql);
$sql="INSERT INTO details (name,trackno) VALUES ('$namesssss','$tracknosssss');";
mysqli_query($con,$sql);
$sql="INSERT INTO details (name,trackno) VALUES ('$namessssss','$tracknossssss');";
mysqli_query($con,$sql);
$sql="INSERT INTO details (name,trackno) VALUES ('$namesssssss','$tracknosssssss');";
mysqli_query($con,$sql);
$sql="INSERT INTO details (name,trackno) VALUES ('$namessssssss','$tracknossssssss');";
mysqli_query($con,$sql);
$sql="INSERT INTO details (name,trackno) VALUES ('$namesssssssss','$tracknosssssssss');";
mysqli_query($con,$sql);
$sql="DELETE FROM tracks;";
mysqli_query($con,$sql);
$sql="INSERT INTO tracks (track) VALUES ('10');";
mysqli_query($con,$sql);
mysqli_close($con);
session_start();
unset($_SESSION['page']);
