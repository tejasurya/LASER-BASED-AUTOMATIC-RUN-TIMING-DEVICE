...
<form action="tracksssssssss.php"  method="post" style="border:1px solid #ccc">
  <div class="container">
    ...
    <br><input type="text" placeholder="track number" value="7" name="trackssssss" readonly>
     <br><label><b>Eighth Athlete</b></label>
    <br><input type="text" placeholder="Enter name" name="namesssssss" required>
    <br><label><b>Track number</b></label>
    <br><input type="text" placeholder="track number" value="8" name="tracksssssss" readonly>
     <br><label><b>Nineth Athlete</b></label>
    <br><input type="text" placeholder="Enter name" name="namessssssss" required>
    <br><label><b>Track number</b></label>
    <br><input type="text" placeholder="track number" value="9" name="trackssssssss" readonly>
     <br><label><b>Tenth Athlete</b></label>
    <br><input type="text" placeholder="Enter name" name="namesssssssss" required>
    <br><label><b>Track number</b></label>
    <br><input type="text" placeholder="track number" value="10" name="tracksssssssss" readonly>
     <div class="align">
      <br>
      <br>
      <br>
